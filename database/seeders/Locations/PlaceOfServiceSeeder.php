...
class PlaceOfServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pos[] = array("code" => "02", "title" => "Telehealth  Provided Other  than in  Patient's  Home", "description" => "N/A");
        ...
        $pos[] = array("code" => "10", "title" => "Telehealth Provided  in Patient's  Home", "description" => "N/A");
