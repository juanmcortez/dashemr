...
class EncounterController extends Controller
{
    ...
    public function show(Encounter $encounter)
    {
        return Inertia::render('Invoices/Show', [
            'invoice' => $encounter->load('patient', 'serviceFacility', 'billingFacility', 'renderingDoctor', 'referringDoctor', 'orderingDoctor', 'supervisingDoctor', 'problemTab', 'miscellaneousTab', 'labTab', 'chargesList')
        ]);
    }
