...
class Rendering extends Model
{
    ...
    {
        if ($this->middleName) {
            return Str::ucfirst(Str::lower($this->firstName)) . ' ' . Str::ucfirst(Str::lower($this->middleName)) . ' ' . Str::ucfirst(Str::lower($this->lastName));
        } else {
            if ($this->lastName && $this->firstName) {
                return Str::ucfirst(Str::lower($this->firstName)) . ' ' . Str::ucfirst(Str::lower($this->lastName));
            } else {
                return '';
            }
        }
